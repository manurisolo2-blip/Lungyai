...
export function MobileOrderBar() {
  return (
    <div className="fixed inset-x-0 bottom-0 z-40 grid grid-cols-2 gap-2 border-t border-line bg-glass px-3 pt-3 pb-[max(0.75rem,env(safe-area-inset-bottom))] md:hidden">
